...
class Submarine:
    ...
    def update(self, dt, sensors):
        ...
        # ADD THIS TRACER BULLET:
        print(f"MISSION STATUS: {status} | THRUSTERS: FWD:{commands.forward:.2f} VERT:{commands.vertical:.2f} YAW:{commands.yaw:.2f} | BLOBS: Red:{len(self.vision.red_blobs)} Green:{len(self.vision.green_blobs)}")
